...
f = open('Naloge\\Naloga_10\\Wiener\\signal0.dat', 'r',encoding='utf-8')
...
f = open('Naloge\\Naloga_10\\Wiener\\signal1.dat', 'r',encoding='utf-8')
data_file=f.readlines()
...
f = open('Naloge\\Naloga_10\\Wiener\\signal2.dat', 'r',encoding='utf-8')
data_file=f.readlines()
...
f = open('Naloge\\Naloga_10\\Wiener\\signal3.dat', 'r',encoding='utf-8')
data_file=f.readlines()
...
plt.grid()
plt.xlabel('čas')
plt.legend(['signal0','signal1','signal3'])
