...
for i in range(N):
    ...
    #Limit single stuff
    A_lt[10+i,i] = 100 #masa

for i in range(len(A_lt[:,0])):
    print(A_lt[i,:])
...
b_lt = [-70,-310,-50,-1000,-18,2000, -60, -3500, -500, 2400]
for i in range(N):
    b_lt.append(maxMass)
b_lt = np.array(b_lt)
...
k = 0
colors = ["black", "gray", "red", "blue", "green", "purple", "orange", "lime", "pink", "goldenrod", "brown", "olive", "cyan", "gold", "skyblue"]
