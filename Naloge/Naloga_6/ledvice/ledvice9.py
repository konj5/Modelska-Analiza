...
def F(c):
    ...
    return (N0 * np.exp(-L0*ts**p0) - ys)

sol = least_squares(F, x0=[1,0.01,0.5], method='lm')
...
ax1.set_title("$N_0 \cdot e^{-L_0t^{p_0}}$")
ax1.set_xticks([]);ax1.set_yticks([]); plt.tight_layout()
print(f"$N_0 = {N0:0.2f}$, $L_0={L0}$, $p_0={p0}$  $\\chi^2 = {hi2:0.2f}$")


plt.savefig("ledvice9.png")
